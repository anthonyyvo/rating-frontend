  ...
  return (
    <div className="likely">
      <div className="header">
        <h2>
          {questionsState.questions?.likely
            ? ""
            : langs.lang === "vi"
          ...
          {langs.lang === "eng" &&
            questionsState.questions?.likely?.questionEng}
      ...
      <div className="body">
        ...
        <div className="scoreWrap">
          <div
            ...
            className={`score ${score === 0 ? "active" : ""}`}
          >
            0
          </div>
          <div
            ...
            className={`score ${score === 1 ? "active" : ""}`}
          >
            1
          </div>
          <div
            ...
            className={`score ${score === 2 ? "active" : ""}`}
          >
            2
          </div>
          <div
            ...
            className={`score ${score === 3 ? "active" : ""}`}
          >
            3
          </div>
          <div
            ...
            className={`score ${score === 4 ? "active" : ""}`}
          >
            4
          </div>
          <div
            ...
            className={`score ${score === 5 ? "active" : ""}`}
          >
            5
          </div>
          <div
            ...
            className={`score ${score === 6 ? "active" : ""}`}
          >
            6
          </div>
          <div
            ...
            className={`score ${score === 7 ? "active" : ""}`}
          >
            7
          </div>
          <div
            ...
            className={`score ${score === 8 ? "active" : ""}`}
          >
            8
          </div>
          <div
            ...
            className={`score ${score === 9 ? "active" : ""}`}
          >
            9
          </div>
          <div
            ...
            className={`score ${score === 10 ? "active" : ""}`}
          >
            10
          </div>
        </div>
