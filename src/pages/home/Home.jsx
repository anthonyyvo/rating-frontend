  ...
  return (
    ...
    >
      ...
      <div className="langs">
        <LanguageIcon />
        <span
          className={`langItem ${langs.lang === "eng" ? "active" : ""}`}
          onClick={() => {
        ...
        <span
          className={`langItem ${langs.lang === "vi" ? "active" : ""}`}
          onClick={() => {
            dispatch({ type: "VIETNAMESE" });
          }}
        >
          VI
        </span>
