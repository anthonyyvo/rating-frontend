...
} from "./context/loginContext/Context";
...
import { CurrentContextProvider } from "./context/currentContext/currentContext";
import { QuestionsContextProvider } from "./context/questionsContext/Context";
import Questions from "./component/admin/questions/Questions";
                ...
                <Routes>
                  ...
                  <Route path="/admin">
                    ...
                    <Route
                      path="q7"
                      element={
                        user ? <List location={7} /> : <Navigate to="/login" />
                      }
                    />
                    <Route
                      path="q1"
                      element={
                        user ? <List location={1} /> : <Navigate to="/login" />
                      }
                    />
                    <Route
                      path="time"
                      element={user ? <Time /> : <Navigate to="/login" />}
                    />
                    <Route
                      path="profile"
